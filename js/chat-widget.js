...
(function () {
  ...
  panel.innerHTML = `
    <div class="gbsc-header">
      <div class="gbsc-header__avatar">${cfg.logoUrl ? `<img src="${cfg.logoUrl}" alt="${cfg.clubName || 'Club'}">` : '⚾'}</div>
      <div class="gbsc-header__info">
        <div class="gbsc-header__name">${cfg.clubName || 'Guildford Baseball Assistant'}</div>
